...
export function oauth_create_qr_callback_bay_68(scenario) {
    //Step 1 : OAUTH
    ...
    const url_qr_callback = 'https://loadtest-new-ops.inet.co.th/bay/api/v1/payment/qr/callback';
    ...
    //console.log(res_qr_callback.body);
    return res_qr_callback
}